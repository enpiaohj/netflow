...
在“快速测试”“场景诊断”“抓包分析”页面可将结果（先脱敏）发送给 AI 模型，获取原因分析与排查建议。当前支持 DeepSeek，需在“设置 → AI 分析”中配置 API Key。发送前可预览全部内容；密码、令牌等敏感字段始终被屏蔽。详见 [用户手册](docs/2026-09-24-NetFlow用户手册-v1.0.md#8-ai-分析)。
...
- [用户手册 v1.0](docs/2026-09-24-NetFlow用户手册-v1.0.md)：各页面操作、端口包、事件日志筛选、抓包方式、AI 分析、数据与隐私。
- [设计变更说明 v1.1](docs/2026-09-24-NetFlow设计变更说明-v1.1.md)：相对设计方案 v1.0 的架构与数据模型变更及决策依据。
