...
- 起始版本 v0.1.0；当前 v0.3.2；M1 诊断闭环完成时 v1.0.0。
- 发布产物命名：`NetFlow-v<MAJOR.MINOR.PATCH>-win-x64.<ext>`（如 `NetFlow-v0.3.2-win-x64.exe`）。
...
- 现有文档：设计方案 v1.0、设计变更说明 v1.3、用户手册 v1.2；根目录 `README.md`、`CHANGELOG.md` 随版本发布同步更新。
